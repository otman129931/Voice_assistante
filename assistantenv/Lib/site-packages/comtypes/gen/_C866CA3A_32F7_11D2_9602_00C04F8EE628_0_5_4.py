...
__all__ = [
    'ISpeechRecognizerStatus', 'SpeechStreamSeekPositionType',
    'ISpeechObjectTokenCategory', 'DISPID_SOTDisplayUI',
    'SPEI_START_INPUT_STREAM', 'DISPID_SOTMatchesAttributes',
    'Speech_Max_Word_Length', 'SRAInterpreter', 'SP_VISEME_21',
    'Speech_StreamPos_Asap', 'SRERecoOtherContext',
    'ISpeechPhraseInfo', 'DISPID_SVSVisemeId',
    'DISPID_SPEEngineConfidence', 'DISPID_SVSCurrentStreamNumber',
    'eLEXTYPE_RESERVED8', 'ISpeechGrammarRules', 'SPAR_Medium',
    'DISPID_SPIRule', 'SPSHT_EMAIL', 'DISPID_SDKDeleteValue',
    'SPEI_SR_AUDIO_LEVEL', 'ISpProperties', 'SPRS_INACTIVE',
    'SPEI_MIN_TTS', 'SPBO_TIME_UNITS', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SLWsCount', 'DISPID_SRGReset', 'SPEI_REQUEST_UI',
    'SPINTERFERENCE_NOSIGNAL', 'SWTDeleted',
    'ISpeechGrammarRuleState', 'DISPID_SpeechLexiconWords',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRAudioInput',
    'SPFM_CREATE_ALWAYS', 'DISPID_SLRemovePronunciation',
    'DISPID_SPRFirstElement', 'DISPID_SRAudioInputStream',
    'SAFTADPCM_8kHzMono', 'SPAS_STOP', 'SREPrivate',
    ...
    'DISPID_SRCESoundEnd', 'DISPID_SRCEInterference',
    'SpeechGrammarTagUnlimitedDictation', 'SREBookmark',
    'DISPID_SPARecoResult', 'DISPID_SLGetPronunciations',
    'DISPID_SRStatus', 'DISPID_SRCEHypothesis', 'SPSFunction',
    'SP_VISEME_6', 'DISPID_SVGetAudioInputs', 'SPWORDLIST',
    'DISPID_SGRSTRule', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SVEViseme', 'SpeechVoiceCategoryTTSRate',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SRCEEnginePrivate', 'ISpPhraseAlt', 'SPPS_Noun',
    'DISPID_SGRSTsCount', 'SpeechRecoContextState',
    'DISPID_SpeechFileStream', 'SVP_2', 'DISPID_SGRSRule',
    'SpeechVoicePriority', 'SWPKnownWordPronounceable', 'SVSFNLPMask',
    'DISPID_SRRSpeakAudio', 'SVEPhoneme', 'SPEI_TTS_AUDIO_LEVEL',
    'ISpRecoResult', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SPEDisplayAttributes',
    'DISPID_SPIGetText', 'DISPID_SADefaultFormat', 'ISpRecognizer3',
    'SWPUnknownWordPronounceable', 'DISPID_SGRName', 'SGDisplay',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpDataKey', 'SPPS_RESERVED2',
    'SAFTGSM610_44kHzMono', 'SSFMOpenForRead', 'SAFT11kHz8BitMono',
    'SPEI_MIN_SR', 'SPXMLRESULTOPTIONS', 'SPSSuppressWord',
    'SAFT16kHz8BitStereo', 'SDA_Two_Trailing_Spaces',
    'DISPID_SpeechPhraseInfo', 'eWORDTYPE_DELETED',
    'SPEI_PHRASE_START', 'ISpStreamFormatConverter',
    'DISPID_SPIAudioStreamPosition', 'SVP_6',
    'DISPID_SREmulateRecognition', 'DISPID_SPEAudioSizeTime',
    'DISPID_SGRSTransitions', 'DISPID_SLGetGenerationChange',
    'SpMMAudioOut', 'SGDSActiveUserDelimited', 'SP_VISEME_7',
    'SPEI_WORD_BOUNDARY', 'SWPUnknownWordUnpronounceable',
    'ISequentialStream', 'STCLocalServer',
    'SpeechCategoryRecognizers', 'SPLEXICONTYPE',
    'DISPID_SpeechPhraseAlternates', 'SVP_12',
    'SAFTNonStandardFormat', 'ISpeechPhraseRule',
    'SpeechPropertyResourceUsage', 'eLEXTYPE_PRIVATE7', 'SPAS_RUN',
    'SPTEXTSELECTIONINFO', 'ISpResourceManager', 'SDTAll',
    'DISPID_SPPsCount', 'SPEI_TTS_PRIVATE', 'SPWORDPRONUNCIATIONLIST',
    'ISpeechLexiconWords', 'SRERequestUI',
    'DISPID_SVSInputWordPosition', 'SP_VISEME_10', 'SPXRO_SML',
    'SVP_11', 'SpeechTokenContext', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SPIElements', 'DISPID_SDKEnumKeys', 'SpeechGrammarState',
    'SpeechVoiceSpeakFlags', 'SINoise', 'eLEXTYPE_PRIVATE13',
    'DISPID_SpeechPhraseElements', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SWFEExtraData', 'ISpPhoneConverter',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPSHORTCUTTYPE',
    'DISPID_SRCCmdMaxAlternates', 'SAFTADPCM_11kHzStereo',
    'DISPID_SABIEventBias', 'SVP_1', 'SPAS_PAUSE',
    'SAFT24kHz8BitStereo', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SGRsFindRule', 'DISPID_SASNonBlockingIO', 'SPPS_Modifier',
    'SPPS_Interjection', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SRCRetainedAudio',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SGRSTNextState', 'DISPID_SRCERecognition',
    'DISPID_SGRSAddSpecialTransition', 'SAFTADPCM_11kHzMono',
    'DISPID_SPAs_NewEnum', 'SPSVerb', 'SGSEnabled', 'SPPS_Function',
    'DISPID_SpeechAudioFormat', 'SDTDisplayText', 'SPGS_EXCLUSIVE',
    'DISPID_SVEEnginePrivate', 'SPINTERFERENCE_NOISE', 'IStream',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVEViseme',
    'STCInprocHandler', 'DISPID_SPPValue', 'DISPID_SLPType',
    'DISPID_SPEs_NewEnum', 'DISPID_SLWType', 'SPEI_VOICE_CHANGE',
    'ISpRecoGrammar', 'DISPID_SLGetWords', 'SLOStatic',
    'ISpeechPhraseRules', 'DISPID_SLWPronunciations',
    'DISPID_SRCERequestUI', 'SPDKL_LocalMachine', 'SPEI_SR_BOOKMARK',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpRecognizer2',
    'SpeechDiscardType', 'SPWORD', 'DISPID_SVEventInterests',
    'SGPronounciation', 'SVEEndInputStream', 'ISpeechDataKey',
    'DISPID_SGRSTPropertyName', 'DISPID_SGRSTs_NewEnum', 'SPSNoun',
    'DISPID_SRCEAudioLevel', 'DISPID_SRGDictationSetState',
    'SPEVENTENUM', 'SRERecognition', 'DISPID_SOTCreateInstance',
    'DISPID_SPEActualConfidence', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRRGetXMLResult', 'SVSFUnusedFlags',
    ...
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SPPParent', 'DISPID_SPRuleId',
    'DISPID_SRCreateRecoContext', 'DISPID_SMSALineId',
    'DISPID_SFSClose', 'SpMMAudioIn', 'IEnumSpObjectTokens',
    'SAFT44kHz16BitStereo', 'SP_VISEME_11',
    'DISPID_SVSInputWordLength', 'DISPID_SPRules_NewEnum',
    'SDTReplacement', 'DISPID_SpeechPhraseBuilder',
    ...
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SVVolume', 'SVP_21',
    'SpeechUserTraining', 'SAFT8kHz8BitMono', 'SGSDisabled',
    'SAFT11kHz16BitStereo', 'DISPID_SDKSetStringValue',
    'ISpeechPhraseInfoBuilder', 'ISpeechXMLRecoResult', 'SDTProperty',
    'ISpeechLexiconPronunciation', 'eLEXTYPE_VENDORLEXICON',
    'SVSFParseAutodetect', 'SPCONTEXTSTATE',
    'DISPID_SGRSAddWordTransition', 'SGSExclusive', 'SPRST_INACTIVE',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPIDSPTSI_SelectionLength',
    'SP_VISEME_19', 'SVSFlagsAsync', 'DISPID_SOTs_NewEnum',
    'SPINTERFERENCE_TOOFAST', 'SVP_18', 'ISpRecoContext',
    'DISPID_SGRSTType', 'SP_VISEME_20', 'SINone',
    'SDA_One_Trailing_Space', 'SpeechCategoryAudioOut',
    'SpeechDataKeyLocation', 'DISPID_SPPBRestorePhraseFromMemory',
    ...
    'ISpeechPhraseElements', 'DISPID_SPRsItem', 'SLTUser',
    'SpeechBookmarkOptions', 'SPSNotOverriden',
    'ISpeechPhoneConverter', 'SPEI_MAX_SR', 'DISPID_SPCPhoneToId',
    'SPLO_STATIC', 'SPPS_Verb', 'SAFTExtendedAudioFormat',
    'eLEXTYPE_PRIVATE18', 'SpInprocRecognizer', 'SRTReSent',
    'SREPhraseStart', 'DISPID_SpeechRecoContext', 'SP_VISEME_18',
    'DISPID_SPPsItem', 'SPSERIALIZEDPHRASE',
    'DISPID_SRSSupportedLanguages',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SDKOpenKey',
    'DISPID_SRRTLength', 'SpeechAudioState', 'SVEVoiceChange',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SpeechPhraseProperty',
    'SPSHORTCUTPAIRLIST', 'ISpeechLexicon', 'DISPID_SVEAudioLevel',
    'Speech_StreamPos_RealTime', 'SAFT12kHz8BitMono',
    'ISpObjectToken', 'DISPID_SPCIdToPhone',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SMSSetData', 'eLEXTYPE_PRIVATE11', 'DISPID_SOTRemove',
    'SAFTCCITT_ALaw_22kHzMono', 'SVP_15',
    'DISPID_SPRDisplayAttributes', 'DISPID_SGRs_NewEnum',
    'DISPID_SpeechRecognizer', 'SpTextSelectionInformation',
    'SPBO_NONE', 'SPAO_RETAIN_AUDIO', 'DISPID_SPPNumberOfElements',
    'SpeechRecognizerState', 'SpResourceManager', 'SVEWordBoundary',
    'SVEAudioLevel', 'IInternetSecurityMgrSite', 'DISPID_SVVoice',
    'ISpeechPhraseReplacement', 'SVPOver', 'SPSLMA',
    'DISPID_SRCResume', 'SVSFParseSapi', 'eLEXTYPE_PRIVATE15',
    'SPAO_NONE', 'SPSMF_UPS', 'SECFIgnoreCase', 'eLEXTYPE_RESERVED7',
    'DISPID_SRCRequestedUIType', 'SECFIgnoreWidth',
    'SpeechCategoryRecoProfiles', 'DISPID_SRGCommit',
    'eLEXTYPE_PRIVATE17', 'SpeechAudioFormatGUIDWave',
    'DISPID_SGRSTPropertyId', 'SAFTGSM610_22kHzMono',
    'DISPID_SVPriority', 'SPPARTOFSPEECH',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVPAlert',
    'SpeechRuleState', 'DISPID_SVEVoiceChange', 'SPWAVEFORMATTYPE',
    'SpeechAddRemoveWord', 'SAFT48kHz16BitMono', 'SP_VISEME_17',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpeechPhraseElement',
    'eLEXTYPE_PRIVATE19', 'SPRECOSTATE', 'SITooSlow',
    'SpeechAudioVolume', 'SAFTNoAssignedFormat',
    'SPEI_PROPERTY_NUM_CHANGE', 'SVF_Stressed', 'ISpPhrase',
    'tagSPTEXTSELECTIONINFO', 'SpeechEngineProperties',
    'DISPID_SAVolume', 'IInternetSecurityManager',
    'SPSEMANTICERRORINFO', 'ISpeechPhraseAlternate',
    'DISPID_SpeechCustomStream', 'SPRS_ACTIVE', 'eLEXTYPE_PRIVATE9',
    'UINT_PTR', 'SPDKL_CurrentUser', 'SPWORDPRONUNCIATION',
    'DISPID_SVSLastBookmarkId', 'SpeechPartOfSpeech', 'SPLOADOPTIONS',
    'SAFTCCITT_ALaw_8kHzMono', 'SAFTADPCM_8kHzStereo',
    'DISPID_SPAStartElementInResult', 'ISpeechVoiceStatus',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SOTSetId',
    'DISPID_SVDisplayUI', 'SVP_13', 'SSSPTRelativeToCurrentPosition',
    'SAFT44kHz8BitMono', 'DISPID_SRDisplayUI', 'SVSFNLPSpeakPunc',
    'ISpEventSource', 'SpeechCategoryAudioIn', 'SRAONone',
    'SPSHT_OTHER', 'ISpeechMMSysAudio', 'DISPID_SPISaveToMemory',
    'ISpeechObjectTokens', 'SPCT_COMMAND', 'DISPID_SBSWrite',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRRAudioFormat',
    'LONG_PTR', 'SpeechSpecialTransitionType', 'DISPID_SPIEngineId',
    'DISPID_SRGDictationUnload', 'DISPID_SRRPhraseInfo',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SAFSetWaveFormatEx', 'SAFT12kHz8BitStereo',
    'DISPID_SPIProperties', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SVSpeakStream', 'SpeechRegistryUserRoot',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpeechPhraseAlternates',
    'DISPID_SVStatus', 'ISpeechRecoResultDispatch', 'SRTStandard',
    'SAFT8kHz16BitMono', 'DISPID_SLPsItem', 'SAFT32kHz8BitStereo',
    'SAFT48kHz8BitStereo', 'SPEI_END_INPUT_STREAM',
    'SPEI_SOUND_START', 'Speech_Max_Pron_Length',
    'DISPID_SGRAttributes', 'SASPause', 'SPADAPTATIONRELEVANCE',
    'ISpeechResourceLoader', 'SPPHRASERULE',
    'DISPID_SpeechPhoneConverter', 'eLEXTYPE_PRIVATE14',
    'SREAudioLevel', 'SP_VISEME_0', 'DISPID_SpeechLexiconWord',
    'SAFT16kHz8BitMono', 'ISpeechAudioBufferInfo',
    'SPRECORESULTTIMES', 'SP_VISEME_5', 'SpeechInterference',
    'SpPhraseInfoBuilder', 'SAFTADPCM_44kHzStereo', 'SPWT_LEXICAL',
    'SpeechStreamFileMode', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPIDSPRG', 'eLEXTYPE_RESERVED4', 'SDTLexicalForm',
    'IEnumString', 'SPFILEMODE', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRGRecoContext', 'SPFM_NUM_MODES', 'SPSHORTCUTPAIR',
    'SRTEmulated', 'ISpeechRecoResult2', 'DISPID_SBSRead',
    'SPINTERFERENCE_TOOQUIET', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRRAlternates', 'ISpeechRecoContext', 'SP_VISEME_16',
    'SRAExport', 'SDKLDefaultLocation', 'SpeechAudioFormatGUIDText',
    'SAFT48kHz16BitStereo', 'DISPID_SRRSaveToMemory',
    'ISpeechLexiconPronunciations', 'DISPID_SPIGrammarId',
    'DISPID_SRGCmdLoadFromResource', 'SAFT16kHz16BitMono', 'SVP_10',
    'ISpeechObjectToken', 'DISPID_SDKGetlongValue',
    'DISPID_SRCEventInterests', 'SVP_7', 'SPVPRI_NORMAL',
    'SPPS_RESERVED1', 'eWORDTYPE_ADDED', 'SSSPTRelativeToEnd',
    'DISPID_SPRulesItem', 'SpeechRuleAttributes',
    'DISPID_SRCSetAdaptationData', 'DISPID_SPRsCount', 'SpFileStream',
    'DISPIDSPTSI_ActiveLength', 'SpCustomStream', 'SVF_Emphasis',
    'DISPID_SPRuleParent', 'DISPID_SASetState', 'SRSActiveAlways',
    'SpeechRecoProfileProperties', 'SAFT8kHz16BitStereo',
    'SAFT24kHz8BitMono', 'SRSEIsSpeaking', 'SREAdaptation',
    'ISpObjectTokenCategory', 'ISpeechRecognizer',
    'DISPID_SOTGetDescription', 'DISPID_SPELexicalForm',
    'SPGS_DISABLED', 'DISPID_SPEPronunciation', 'SECFNoSpecialChars',
    'SECFIgnoreKanaType', 'SDKLCurrentConfig',
    'DISPID_SPIEnginePrivateData', 'SVSFDefault',
    'DISPID_SPRulesCount', 'DISPID_SOTCDefault', 'DISPID_SRGState',
    'SRSInactive', 'DISPID_SRGSetWordSequenceData', 'SRARoot',
    'ISpMMSysAudio', 'DISPID_SVAlertBoundary', 'DISPID_SDKDeleteKey',
    'SP_VISEME_3', 'SP_VISEME_15', 'SPVPRI_OVER',
    'SPWT_PRONUNCIATION', 'DISPID_SWFESamplesPerSec',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPWT_DISPLAY', 'SPSHT_Unknown',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRSAudioStatus',
    'SPCT_SLEEP', 'DISPIDSPTSI_SelectionOffset', 'SPCATEGORYTYPE',
    'DISPIDSPTSI_ActiveOffset', 'SpeechRecognitionType',
    'SpeechAudioProperties', 'STSF_AppData', 'SREAllEvents',
    'DISPID_SVSInputSentencePosition', 'SRAImport',
    'DISPID_SpeechRecoResult2', 'SpMemoryStream', 'ISpStreamFormat',
    'DISPID_SRCPause', 'ISpeechWaveFormatEx', 'SAFTGSM610_11kHzMono',
    'DISPID_SPRText', 'SpeechPropertyResponseSpeed',
    'SPEI_SR_PRIVATE', 'SpeechEngineConfidence',
    'DISPID_SGRSTPropertyValue', 'SVSFIsNotXML',
    'SpeechVisemeFeature', 'DISPID_SVSpeak', '_ISpeechVoiceEvents',
    'DISPID_SAFGuid', 'DISPID_SVPause', 'SAFT12kHz16BitStereo',
    'ISpeechRecoGrammar', 'SAFT8kHz8BitStereo', 'DISPID_SVEPhoneme',
    'SPLO_DYNAMIC', 'ISpRecoCategory',
    'DISPID_SPIGetDisplayAttributes', 'SAFT22kHz8BitStereo',
    'SpObjectTokenCategory', 'DISPID_SBSFormat', 'SVSFIsFilename',
    'DISPID_SLPPartOfSpeech', 'SPWORDTYPE', 'SP_VISEME_13',
    'ISpPhoneticAlphabetSelection', 'SGRSTTWord', 'ISpeechRecoResult',
    'SPRST_ACTIVE_ALWAYS', 'eLEXTYPE_PRIVATE8',
    ...
    'DISPID_SpeechPhraseElement', 'ISpeechLexiconWord',
    'ISpGrammarBuilder', 'DISPID_SGRsCommitAndSave',
    'ISpXMLRecoResult', 'SLODynamic', 'DISPID_SRGRules', 'SVP_9',
    'DISPID_SVGetProfiles', 'SpPhoneConverter',
    'DISPID_SRSClsidEngine', 'SVEAllEvents', 'SPPS_Noncontent',
    'DISPID_SRGCmdSetRuleState', 'SAFT11kHz16BitMono',
    'SpeechVisemeType', 'ISpRecoContext2', 'SWTAdded',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPIAudioSizeTime',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SDA_Consume_Leading_Spaces', 'SDA_No_Trailing_Space',
    'SRATopLevel', 'DISPID_SRCBookmark', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SOTsCount', 'DISPID_SPAsCount', 'SVP_0',
    'ISpeechPhraseProperties', 'SpeechLoadOption',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRSCurrentStreamPosition',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPSHT_NotOverriden', 'SPRULE',
    'SPCT_SUB_COMMAND', 'SRADefaultToActive',
    'SpPhoneticAlphabetConverter', 'SPSInterjection',
    'DISPID_SFSOpen', 'DISPID_SOTCategory', 'DISPID_SOTIsUISupported',
    'SpeechPropertyAdaptationOn',
    'SpeechPropertyNormalConfidenceThreshold', 'SAFT32kHz16BitMono',
    'SLTApp', 'DISPID_SABufferInfo', 'ISpSerializeState',
    'eLEXTYPE_RESERVED9', 'DISPID_SGRsAdd',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SRCEBookmark',
    'DISPID_SGRAddResource', 'DISPID_SPEDisplayText',
    'SPPS_NotOverriden', 'ISpeechRecoResultTimes',
    'SECNormalConfidence', 'SVSFPersistXML', 'DISPID_SOTId',
    'DISPID_SLGenerationId', 'DISPID_SRCEFalseRecognition',
    'tagSTATSTG', 'eLEXTYPE_RESERVED6', '_RemotableHandle',
    'DISPID_SOTGetAttribute', 'SpeechAllElements', 'SDKLCurrentUser',
    'SPAR_Unknown', 'eLEXTYPE_USER', 'DISPID_SRRecognizer',
    'eLEXTYPE_APP', 'DISPID_SPPId', 'SP_VISEME_9', 'SPINTERFERENCE',
    'DISPID_SPACommit', 'DISPID_SDKCreateKey', 'SGDSActive',
    'SVEStartInputStream', 'SPCT_DICTATION',
    'DISPID_SpeechPhraseRules', 'SPVISEMES', 'SAFTText',
    'DISPID_SAStatus', 'SpeechTokenKeyFiles', 'SECFEmulateResult',
    'SPCT_SUB_DICTATION', 'eLEXTYPE_PRIVATE4', 'DISPID_SpeechAudio',
    'ISpLexicon', 'SRTSMLTimeout', 'SAFT12kHz16BitMono',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVPNormal', 'SVP_5',
    'SVP_19', 'DISPID_SVEStreamStart', 'SRSActive',
    'SpeechLexiconType', 'DISPID_SOTCId', 'DISPID_SPRuleChildren',
    'SREFalseRecognition', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpShortcut', 'SVP_14', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SVSInputSentenceLength', 'SpStreamFormatConverter',
    'DISPID_SpeechObjectToken', 'SPEI_PHONEME', 'SDTAudio',
    'SASClosed', 'SPWF_SRENGINE',
    'SpeechPropertyHighConfidenceThreshold', 'SREStreamStart',
    'SP_VISEME_1', 'eLEXTYPE_PRIVATE1', 'ISpAudio', 'SPPS_RESERVED3',
    'DISPID_SWFEChannels', 'DISPID_SLPLangId', 'SPEI_INTERFERENCE',
    'ISpeechPhraseProperty', 'SRSInactiveWithPurge',
    'DISPID_SVSRunningState', 'SpNullPhoneConverter',
    'ISpObjectWithToken', 'DISPID_SGRInitialState',
    'SGDSActiveWithAutoPause', 'DISPID_SpeechDataKey',
    'DISPID_SRSetPropertyString', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SVAudioOutput', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRRDiscardResultInfo',
    'SpeechGrammarRuleStateTransitionType', 'SpeechTokenShellFolder',
    'SPINTERFERENCE_NONE', 'SBOPause', 'STSF_FlagCreate',
    'DISPID_SABIBufferSize', 'DISPID_SGRsCount', 'SAFT22kHz16BitMono',
    'SP_VISEME_14', 'SPGRAMMARWORDTYPE', 'SPVOICESTATUS',
    'SpeechTokenValueCLSID', 'DISPID_SLWsItem', 'SpMMAudioEnum',
    'SpeechCategoryAppLexicons', 'DISPID_SRCState',
    'SPSTREAMFORMATTYPE', 'SPAUDIOOPTIONS',
    'DISPID_SpeechMemoryStream', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SASFreeBufferSpace', 'DISPID_SRRAudio',
    'DISPID_SRIsShared', 'DISPID_SASCurrentSeekPosition',
    'SpShortcut', 'SAFT22kHz8BitMono', 'DISPID_SRGCmdSetRuleIdState',
    'SpObjectToken', 'DISPID_SRGetFormat', 'SPSUnknown',
    'SVSFParseSsml', 'DISPID_SpeechBaseStream', 'DISPID_SPRs_NewEnum',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SVEWord', 'SpeechGrammarTagWildcard',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SVRate',
    'SAFT44kHz8BitStereo', 'eLEXTYPE_PRIVATE6', 'ISpNotifySource',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SPIStartTime',
    'SPPHRASEELEMENT', 'DISPID_SVAudioOutputStream',
    'SpInProcRecoContext', 'ISpeechFileStream', 'SpWaveFormatEx',
    'SAFT22kHz16BitStereo', 'DISPID_SpeechGrammarRules', 'SVP_4',
    'SPVPRI_ALERT', 'SpeechGrammarTagDictation',
    'SAFTGSM610_8kHzMono', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRGCmdLoadFromObject', 'SPRST_ACTIVE',
    'SAFTCCITT_uLaw_8kHzMono', 'SpUnCompressedLexicon',
    'DISPID_SpeechGrammarRule', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechGrammarWordType',
    'SpeechWordType', 'SAFTADPCM_22kHzStereo',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SLWWord', 'DISPID_SRGId',
    'STSF_LocalAppData', 'SSSPTRelativeToStart',
    'DISPID_SLWs_NewEnum', 'DISPID_SPANumberOfElementsInResult',
    'ISpRecognizer', 'SpLexicon', 'DISPID_SGRId', 'SpeechTokenKeyUI',
    'SPSERIALIZEDRESULT', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRRTimes', 'DISPID_SOTCEnumerateTokens',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SABIMinNotification',
    'DISPID_SLAddPronunciation', 'DISPID_SMSAMMHandle',
    'SpeechVoiceEvents', 'SAFT44kHz16BitMono', 'ISpNotifySink',
    'SPEI_TTS_BOOKMARK', 'DISPID_SVEStreamEnd', 'SRESoundEnd',
    'SDTAlternates', 'tagSPPROPERTYINFO', 'SGLexicalNoSpecialChars',
    ...
    'SDTPronunciation', 'DISPID_SVGetVoices', 'eLEXTYPE_PRIVATE12',
    'ISpeechAudioStatus', 'SAFT16kHz16BitStereo', 'SPSEMANTICFORMAT',
    'SPAR_Low', 'DISPID_SOTDataKey', 'SSFMCreate',
    'DISPID_SOTRemoveStorageFileName', 'SpNotifyTranslator',
    'SpVoice', 'DISPID_SpeechObjectTokens', 'DISPID_SLWLangId',
    'SECFDefault', 'SAFT11kHz8BitStereo', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SPERetainedSizeBytes', 'SpeechFormatType', 'SASRun',
    'DISPID_SpeechPhraseAlternate', 'SPAS_CLOSED', 'SASStop',
    'DISPID_SCSBaseStream', 'SRADynamic', 'SRESoundStart',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRCEEndStream', 'SPEI_MAX_TTS',
    'ISpStream', 'SpeechWordPronounceable', 'SVP_17', 'SPBO_AHEAD',
    'SpeechEmulationCompareFlags', 'SVP_16',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRRTOffsetFromStart',
    'SPEI_RESERVED3', 'DISPID_SDKSetBinaryValue',
    'DISPID_SRRTTickCount', 'SpAudioFormat', 'SGLexical',
    'SITooQuiet', 'SpeechRunState', 'SPRECOGNIZERSTATUS',
    'SRTExtendableParse', 'ISpeechPhraseReplacements', 'STCAll',
    'SDKLLocalMachine', 'SPPS_LMA', 'DISPID_SPAsItem', 'WAVEFORMATEX',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SGRClear',
    'SpCompressedLexicon', 'SPEI_START_SR_STREAM', 'SGRSTTDictation',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPPConfidence',
    'SVSFPurgeBeforeSpeak', 'SPAUDIOBUFFERINFO', 'DISPID_SASState',
    'eLEXTYPE_PRIVATE16', 'DISPID_SBSSeek', 'DISPID_SPRuleConfidence',
    'SPINTERFERENCE_TOOLOUD', 'SPBOOKMARKOPTIONS', 'SVSFParseMask',
    'SSFMCreateForWrite', 'SPRST_NUM_STATES', 'DISPID_SRCVoice',
    'DISPID_SpeechObjectTokenCategory', 'SPPHRASEPROPERTY',
    'SVF_None', 'eLEXTYPE_LETTERTOSOUND', 'DISPID_SRRGetXMLErrorInfo',
    'SAFT24kHz16BitMono', 'SPRULESTATE', 'SPFM_OPEN_READONLY',
    'SFTSREngine', 'DISPID_SVSkip', 'DISPID_SVWaitUntilDone',
    'SPPS_SuppressWord', 'SPVPRIORITY', 'DISPID_SVIsUISupported',
    'SpeechAudioFormatType', 'SPAUDIOSTATUS', 'DISPID_SLPsCount',
    ...
    'SFTInput', 'ISpeechMemoryStream', 'DISPID_SRCVoicePurgeEvent',
    'SREInterference', 'SPPHRASEREPLACEMENT', 'SPFM_CREATE',
    'DISPID_SPRuleNumberOfElements', 'ISpVoice',
    'DISPID_SRGIsPronounceable', 'DISPID_SVSPhonemeId',
    'DISPID_SVResume', 'ISpeechAudio', 'SPBO_PAUSE',
    'ISpeechCustomStream', 'SAFTADPCM_44kHzMono',
    'DISPID_SPPFirstElement', 'DISPID_SpeechVoiceStatus',
    'DISPID_SpeechVoiceEvent', 'SPPS_Unknown',
    'DISPID_SRCESoundStart', 'SAFTDefault', 'DISPID_SpeechMMSysAudio',
    'DISPID_SDKEnumValues', 'DISPID_SRCEPhraseStart',
    'DISPID_SpeechPhraseRule',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPWORDPRONOUNCEABLE',
    'DISPID_SRGetPropertyString', 'DISPID_SRCRetainedAudioFormat',
    'SECLowConfidence', 'SRTAutopause', 'DISPID_SAEventHandle',
    'SSFMOpenReadWrite', 'SP_VISEME_2', 'DISPID_SPPs_NewEnum',
    'DISPID_SLPPhoneIds', 'DISPID_SGRSTsItem',
    'SpeechTokenKeyAttributes', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPAUDIOSTATE', 'DISPID_SGRsCommit', 'DISPID_SRState',
    'DISPID_SPCLangId', 'SPEI_RESERVED1', 'SVSFIsXML',
    ...
    'DISPID_SpeechWaveFormatEx', 'DISPID_SpeechLexicon',
    'ISpRecoGrammar2', 'SGRSTTTextBuffer',
    'DISPID_SpeechPhraseReplacement', 'SPEI_ADAPTATION',
    'SpeechTokenIdUserLexicon', 'SVEBookmark',
    'DISPID_SPERequiredConfidence', 'DISPID_SRProfile', 'SPEI_VISEME',
    'SVEPrivate', 'SpeechMicTraining', 'DISPID_SpeechVoice',
    'SPGS_ENABLED', 'SAFTADPCM_22kHzMono', 'SPCS_DISABLED',
    'SREStateChange', 'SPEI_RESERVED2', 'DISPID_SRCEStartStream',
    'ISpeechVoice', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SpeechRecoResult', 'DISPID_SPPName', 'SECHighConfidence',
    'SPEVENT', 'DISPID_SRRTStreamTime', 'ISpeechAudioFormat',
    'SPEI_RECOGNITION', 'SGRSTTRule', 'DISPID_SPILanguageId',
    'SP_VISEME_4', 'DISPID_SPRNumberOfElements', 'SPPROPERTYINFO',
    'SITooFast', 'SPDKL_CurrentConfig', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPEI_RESERVED5', 'DISPID_SRGSetTextSelection', 'SPSModifier',
    'ISpEventSink', 'ISpeechBaseStream', 'SVP_20',
    'SpSharedRecognizer', 'SPGRAMMARSTATE', 'SpeechDisplayAttributes',
    'SGRSTTWildcard', 'eLEXTYPE_RESERVED10', '_SPAUDIOSTATE',
    'SRCS_Disabled', 'DISPID_SWFEBlockAlign', 'SVESentenceBoundary',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SDKGetStringValue',
    'eLEXTYPE_PRIVATE2', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SVSyncronousSpeakTimeout',
    'ISpeechTextSelectionInformation', 'DISPID_SRGetPropertyNumber',
    'SpSharedRecoContext', 'SGRSTTEpsilon', 'SPWF_INPUT',
    'SPFM_OPEN_READWRITE', 'SPEI_HYPOTHESIS', 'DISPID_SLPSymbolic',
    'ISpNotifyTranslator', 'DISPID_SOTCSetId', 'STSF_CommonAppData',
    'SRAORetainAudio', 'SPDKL_DefaultLocation',
    'Speech_Default_Weight', 'SpStream', 'DISPID_SWFEFormatTag',
    'SPPHRASE', 'SP_VISEME_8', 'DISPID_SDKGetBinaryValue',
    'DISPID_SPIReplacements', 'SSTTWildcard', 'SSTTTextBuffer',
    'SREStreamEnd', '_ISpeechRecoContextEvents', 'DISPID_SGRsItem',
    'DISPID_SRRRecoContext', 'DISPID_SPAPhraseInfo',
    'DISPID_SOTGetStorageFileName', 'SP_VISEME_12',
    'SpeechRecoEvents', 'DISPID_SGRSTWeight', 'DISPID_SPPChildren',
    'SSTTDictation', 'SPAR_High', 'SpeechDictationTopicSpelling',
    'SAFT48kHz8BitMono', 'DISPID_SABufferNotifySize',
    'DISPID_SRGDictationLoad', 'DISPID_SRCCreateGrammar',
    'SRCS_Enabled', 'SPBINARYGRAMMAR', 'SDTRule', 'SVP_3',
    'SPCS_ENABLED', 'DISPID_SpeechAudioBufferInfo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SPEsCount',
    'SVP_8', 'SINoSignal', 'eLEXTYPE_PRIVATE3', 'SPDATAKEYLOCATION',
    'SPEI_UNDEFINED', 'ISpeechGrammarRule',
    'DISPID_SVESentenceBoundary', 'SPEI_END_SR_STREAM',
    'SPEI_SOUND_END', 'SRSEDone', 'SBONone',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SVSLastBookmark',
    'DISPID_SOTsItem', 'DISPID_SVSLastResult', 'SPEVENTSOURCEINFO',
    'DISPID_SGRAddState', 'DISPID_SLPs_NewEnum', 'DISPIDSPTSI',
    'SREPropertyStringChange', 'SAFT32kHz8BitMono',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SGRsDynamic',
    'SpeechCategoryVoices', 'DISPID_SRGetRecognizers',
    'SPEI_RESERVED6', 'DISPID_SOTCGetDataKey',
    '__MIDL_IWinTypes_0009', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SMSADeviceId'
]

_check_version('1.2.0', 1617976477.269924)
